...
const About=()=>{
    ...
    return(
        ...
        <div className="container mx-auto   m-3 px-12 py-12">
            <motion.h2 ref={ref} variants={variants} initial='initial' animate={controls} className=" text-4xl bg-gradient-to-b from-secondary to-gray-400 text-transparent bg-clip-text pb-4">About</motion.h2>
